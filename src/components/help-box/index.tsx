...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Chief Nutritionist'];
  const customerRoles: string[] = ['Patients'];
  const tenantRoles: string[] = ['Consultant', 'Chief Nutritionist'];
  const addOns: string[] = ['notifications', 'file upload', 'chat', 'file'];
  const applicationName = `Get Fit with Dr Madhuri`;
  const tenantName = `Functional Nutritionist`;
